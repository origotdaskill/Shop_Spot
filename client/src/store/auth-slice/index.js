...
export const registerUser = createAsyncThunk(
  ...
  async (formData) => {
    const response = await axios.post(
      "https://shop-spot-backend.onrender.com/api/auth/register",
      formData,
      {
...
export const loginUser = createAsyncThunk(
  ...
  async (formData) => {
    const response = await axios.post(
      "https://shop-spot-backend.onrender.com/api/auth/login",
      formData,
      {
        withCredentials: true,
      }
...
export const logoutUser = createAsyncThunk("/auth/logout", async () => {
  const response = await axios.post(
    "https://shop-spot-backend.onrender.com/api/auth/logout",
    {},
    {
      withCredentials: true,
    }
...
export const checkAuth = createAsyncThunk("/auth/checkauth", async () => {
  ...
  const response = await axios.get(
    "https://shop-spot-backend.onrender.com/api/auth/check-auth",
    {
      withCredentials: true,
      headers: {
        "Cache-Control":
